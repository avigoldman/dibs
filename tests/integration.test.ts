...
describe("npm (integration)", () => {
  it("detects a taken package", async () => {
  ...
  it("detects an available package", async () => {
    const { checkNpm } = await import("../src/checkers/npm.js");
...
describe("GitHub (integration)", () => {
  it("detects a taken username", async () => {
  ...
  it("detects an available username", async () => {
    const { checkGitHub } = await import("../src/checkers/github.js");
...
describe("Domain (integration)", () => {
  it("detects google.com as taken", async () => {
  ...
  it("detects a nonsense .com as available", async () => {
    const { checkDomain } = await import("../src/checkers/domain.js");
    const result = await checkDomain(KNOWN_AVAILABLE, ".com");
    expect(result.status).toBe("available");
  }, TIMEOUT);

  it("checks multiple TLDs at once", async () => {
...
describe("X / Twitter (integration)", () => {
  it("detects a taken handle", async () => {
...
describe("Instagram (integration)", () => {
  ...
  it("detects an available handle", async () => {
    const { checkInstagram } = await import("../src/checkers/instagram.js");
...
describe("LinkedIn (integration)", () => {
  it("detects a taken company page", async () => {
...
describe("crates.io (integration)", () => {
  it("detects a taken crate", async () => {
  ...
  it("detects an available crate", async () => {
    const { checkCratesIO } = await import("../src/checkers/crates.js");
...
describe("RubyGems (integration)", () => {
  ...
  it("detects an available gem", async () => {
    const { checkRubyGems } = await import("../src/checkers/rubygems.js");
...
describe("Go pkg.go.dev (integration)", () => {
  it("detects a taken Go package", async () => {
  ...
  it("detects an available Go package", async () => {
    const { checkGoPkg } = await import("../src/checkers/go.js");
...
describe("Homebrew (integration)", () => {
  it("detects a taken formula", async () => {
  ...
  it("detects an available formula", async () => {
    const { checkHomebrew } = await import("../src/checkers/homebrew.js");
...
describe("Docker Hub (integration)", () => {
  it("detects a taken image/org", async () => {
  ...
  it("detects an available image/org", async () => {
    const { checkDockerHub } = await import("../src/checkers/dockerhub.js");
...
describe("USPTO Trademark (integration)", () => {
  ...
  it("checks a nonsense name", async () => {
    const { checkUSPTOTrademark } = await import("../src/checkers/trademark.js");
...
describe("runCheckers (integration)", () => {
  it("runs a subset of checkers end-to-end", async () => {
  ...
  it("never throws — always returns results", async () => {
    const { runCheckers } = await import("../src/checkers/index.js");
